...
coded mask instrument \xgis. It is sensitive to both X-ray and $\gamma$-rays in the 2 keV--10 MeV range. It consists of a coded mask and a silicon
drift detector layer. The most important parameters of the coded-mask and detector geometry are listed in Table \ref{tab:para}.
...
\begin{equation}
    S = \mathcal{F}^{-1} \left( \mathcal{F} \left( M \right) \cdot \mathcal{F} \left( D \right) \right)
\end{equation}  ŝ
